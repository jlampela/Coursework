...
public class ParenthesisChecker {
   ...
   /**
    * This function checks if the given string has matching opening and closing
         ...
         if(a == '(' || a == '[' || a == '{'){
            ...
            try{
               ...
               if (a == '}' && x == '{' || a == ')' && x == '(' || a == ']' && x == '['){
                  ...
                  throw new ParenthesesException(fromString, -1);
               }
            } catch (StackIsEmptyException e){
               throw new ParenthesesException(e.getMessage(), -1);
            }
         }
      }
      return size;
